...
<?= $this->section("body") ?>
    ...
    <div class="containe fadeInUp m-0 main-container-sec mt-2 rounded row shadow wow" data-wow-delay="0.1s">
      <div class="col-md-6">
        <h4 class="text-danger font-weight-bold">GROUP PERFORMANCE</h4>
      </div>
    ...
    <div class="bg-white fadeInUp m-0 mt-2 p-3 row wow rounded shadow">
      <div class="col-md-12 text-center mt-2">
        ...
        <img src="<?=IMG?>ppt_icon.png"></div>
        <img src="<?=IMG?>basic-bar-graph.png" class="w-50">
      </div>

      <div class="col-md-12">
      <div class="d-flex justify-content-end mb-2"><img src="<?=IMG?>excel_icon.png"></div>
